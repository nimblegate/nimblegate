...
func gatewayDashboard(args []string) int {
	...
	reposRoot := fs.String("repos-root", "/srv/gateway/repos", "dir holding the gateway's bare repos (<repo>.git); enables live check preview and staging health")
