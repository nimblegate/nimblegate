...
func BuiltinCheckFuncs() map[string]engine.CheckFunc {
	return map[string]engine.CheckFunc{
		...
		"commands/approved-registries-only":            checks.ApprovedRegistriesOnly,
		...
		"security/no-pii-in-source":                    checks.NoPIIInSource,
		"security/no-env-file-in-repo":                 checks.NoEnvFileInRepo,
		"security/no-terraform-state-in-repo":          checks.NoTerraformStateInRepo,
		"security/no-kubeconfig-in-repo":               checks.NoKubeconfigInRepo,
		"security/no-database-dump-in-repo":            checks.NoDatabaseDumpInRepo,
